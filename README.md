...
```
USE_SA_FDD_MONO=yes,GNB_ID=0xe00,GNB_NAME=gNB-OAI,MCC=001,MNC=01,MNC_LENGTH=2,TAC=1,NSSAI_SST=1,NSSAI_SD=0x1,AMF_IP_ADDRESS=192.168.70.132,GNB_NGA_IF_NAME=net1,GNB_NGA_IP_ADDRESS=192.168.70.139,GNB_NGU_IF_NAME=net1,GNB_NGU_IP_ADDRESS=192.168.70.139,SDR_ADDRS="mgmt_addr=10.10.3.3,addr=10.40.3.3",THREAD_PARALLEL_CONFIG=PARALLEL_SINGLE_THREAD
```
